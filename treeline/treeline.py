...
from model import *
htmlf = open(ptarget+'/treeline.html', 'w')
orgf = open(ptarget+'/treeline.org', 'w')
pfavorites = ptl+'/favorites'
...
def dl_favorites():
    favorites = session.query(Node).filter(Node.favorite==True).all()
    for favorite in favorites:
        pwget=pfavorites+'/'+favorite.title
